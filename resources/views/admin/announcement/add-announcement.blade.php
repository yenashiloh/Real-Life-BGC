            ...
            <div class="page-inner">
                <div class="page-header">
                    ...
                    <ul class="breadcrumbs mb-3">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.announcement.add-announcement') }}">Add Announcement</a>
                        </li>
                    </ul>
                </div>

                <form id="announcementForm" method="POST" action="{{ route('admin.save-announcement') }}">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <p class="text-muted mt-2 fw-bold ps-2">Post an announcement to inform users about updates, events, or important information.</p>
