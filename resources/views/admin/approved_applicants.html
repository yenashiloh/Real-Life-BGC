    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="approved_applicants.html" class="active">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="announcement.html">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="notify.html">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="create_account.html">
