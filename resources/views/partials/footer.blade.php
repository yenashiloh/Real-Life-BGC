        ...
        <div class="container " >
            <div class="row gy-4" >
                ...
                <div class="col-lg-4 col-md-4 col-12 footer-links mb-4">
                    <h4>Resources</h4>
                    <ul>
                        <li><i class="bi bi-chevron-right" style="color:#0A6E57;"></i> <a href="/faq">FAQ</a></li>
                        <li><i class="bi bi-chevron-right" style="color:#0A6E57;"></i> <a href="/announcement">Announcement</a></li>
                    </ul>
                </div>
