                        ...
                        <div class="auth-form-light text-left p-5 pt-3 pb-3">
                            ...
                            <form action="{{ route('login.post') }}" method="POST">
                                ...
                                <div class="form-group text-center mt-4">
                                    <span class="apply_now" style="font-size: 14px;">You want to apply? <a
                                            href="/registration" style="font-size: 14px;">Apply Now</a></span>
                                    <div class="mt-2">
                                        <a href="{{ route('user.forgot-password.forgot-password') }}"
