    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="declined_applicants.html"  class="active">
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <tr>
                    ...
                    <td> <span class="badge bg-danger">For Interview Declined</span></td>
                  ...
                  <tr>
                    ...
                    <td>Derige</td>
                    <td>Fourth Year College</td>
                    <td> <span class="badge bg-danger">For House Visitation Declined</span></td>
                    <td>  <button type="button" class="btn" style="background-color: #2EB85C; color: white; font-size: 12px; width: 80px;">View</button> </td>
                  </tr>
