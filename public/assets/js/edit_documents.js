$(document).ready(function() {
    ...
    var requirementId; // Variable to store requirement ID
    ...
    $('#editFiles').change(function() {
        ...
        checkFormChanges(); // Check for changes after file selection
    });

    // Listen for change events on the document type dropdown
    $('#editDocumentType').change(function() {
        checkFormChanges(); // Check for changes after document type selection
    });

    // Listen for input events on the notes field
    $('#editNotes').on('input', function() {
        checkFormChanges(); // Check for changes after notes input
    });
