 ...
 <section id="progress-form__panel-6" role="tabpanel" aria-labelledby="progress-form__tab-6" tabindex="0" hidden>
     <div class="sm:d-grid sm:grid-col-2 sm:mt-3">
         ...
         <div class="mt-3 form__field">
             ...
             <input value="" id="fatherIncome" type="number" name="fatherIncome" autocomplete="fatherIncome"
                 required>
         </div>
         ...
         <div class="mt-3 form__field">
             ...
             <input value="" id="incomeMother" type="number" name="incomeMother" autocomplete="incomeMother"
                 required>
         </div>
