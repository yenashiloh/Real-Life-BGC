...
tabindex="0" hidden>
  <div class="sm:d-grid sm:grid-col-2 sm:mt-3">
      ...
      <div class="form__field">
          ...
          <select id="attend-orientation" name="attend-orientation" required>
      ...
      <div class="form__field">
          ...
          <input id="orientation-date" type="text" name="orientation-date" required>
      </div>

      <div class="mt-3 form__field">
          <label for="orientation-proof">
              Upload Zoom screenshot proof of attendance
              <span data-required="true" aria-hidden="true"></span>
          </label>
          <input id="orientation-proof" type="file" name="orientation-proof" accept="image/*" required>
      </div>
  </div>
