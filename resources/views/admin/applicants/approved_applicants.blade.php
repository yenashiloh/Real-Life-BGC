                  ...
                  <div class="card-body">
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu">
                          <a class="dropdown-item " href="{{ route('export.approved.applicants', ['format' => 'csv']) }}">CSV</a>
                          <a class="dropdown-item " href="{{ route('export.approved.applicants', ['format' => 'excel']) }}">Excel</a>
                      </div>
                  </div>
