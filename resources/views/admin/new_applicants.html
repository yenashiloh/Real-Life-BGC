    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="new_applicants.html" class="active">
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <tr>
                    ...
                    <td> <span class="badge bg-primary">For Review</span></td>
                    <td>
                        <div style="margin-bottom: 3px;">
                            <button type="button" class="btn" style="background-color: #356ddc; color: white; font-size: 12px; width: 100px;">Shortlisted</button>         
                          </div>
                          <div style="margin-bottom: 3px;">
