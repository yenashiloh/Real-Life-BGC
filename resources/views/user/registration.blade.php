            ...
            @if ($applicationOpen)
                ...
                <section id="progress-form__panel-1" role="tabpanel" aria-labelledby="progress-form__tab-1"
                    ...
                    <div class="mt-3 sm:mt-0 form__field">
                        <p style="font-weight: bold; text-transform: uppercase;">To be eligible to receive the Real
                            LIFE scholarship, applicants must:</p>
                        <ul>
                            <li>
                                Be a Filipino citizen
                            </li>
                            <li>
                                Have a grade weighted average (GWA) of at least 88% or its equivalent in the previous
                                academic year for high school students or the previous semester for college students
                            </li>
                            <li>
                            ...
                            <li>
                                Be enrolled at a school recognized by the Department of Education (DepEd) or Commission
                                on Higher Education (CHED)
                            </li>
                            <li>
                                For high school applicants, be currently studying or willing to transfer to a public
                                school
                            </li>
                            <li>
                    ...
                    <div class="mt-1 form__field">
                        <label class="form__choice-wrapper">
                            <fieldset>
                                ...
                                <span>
                                    I understand that the information I will provide will be used by Real LIFE
                                    Foundation to screen and process my application for SY 2023-2024. I give my consent
                                    to Real LIFE to use the data I will provide and the file attachments for the said
                                    application.
                                </span>
                            </fieldset>
                        </label>
                ...
                <section id="progress-form__panel-2" role="tabpanel" aria-labelledby="progress-form__tab-2"
                    ...
                    <div class="sm:d-grid sm:grid-col-2 sm:mt-3">
                        ...
                        <div class="mt-3 form__field">
                            ...
                            <input value="" id="confirmPasswordField" type="password" name="confirm_password"
                ...
                <!-- Personal information-->
                <section id="progress-form__panel-3" role="tabpanel" aria-labelledby="progress-form__tab-2"
                    tabindex="0" hidden>
                    <div class="sm:d-grid sm:grid-col-2 sm:mt-3">
                        <div class="form__field">
                            <label for="address">
                    ...
                    <div class="sm:d-grid sm:grid-col-12 sm:mt-3">
                        <div class="form__field">
                            ...
                            <input value="" id="mapAddress" type="file" name="mapAddress"
                                autocomplete="map address" required style="padding">
                        </div>
                ...
                <!-- Step 4 -->
                <section id="progress-form__panel-4" role="tabpanel" aria-labelledby="progress-form__tab-3"
                    tabindex="0" hidden>
                ...
                <!-- Step 5 -->
                <section id="progress-form__panel-5" role="tabpanel" aria-labelledby="progress-form__tab-3"
                    tabindex="0" hidden>
                    <div class="sm:d-grid sm:grid-col-2 sm:mt-3">
                        <div class="form__field ">
