        ...
        <div class="container " >
            <div class="row gy-4" >
                <div class="col-lg-4 col-md-4 col-12 footer-links mb-4 ml-md-12">
                    ...
                    <ul>
                        <li><i class="fa fa-chevron-right thin-chevron" class="f-para footer-text" style="color:#ffffff;"></i> <a href="/#mission_statement">Mission</a></li>
                        <li><i class="fa fa-chevron-right thin-chevron" class="f-para footer-text"  style="color:#ffffff;"></i> <a href="/#educational_assistance">Educational
                                Assistance</a></li>
                        <li><i class="fa fa-chevron-right thin-chevron" class="f-para footer-text"  style="color:#ffffff;"></i> <a href="/#character_formation">Character
                                Formation</a></li>
                        <li><i class="fa fa-chevron-right thin-chevron" class="f-para footer-text"  style="color:#ffffff;"></i> <a href="/#leadership_development">Leadership
                                Development</a></li>
                    </ul>
                </div>
                <div class="col-lg-4 col-md-4 col-12 footer-links mb-4">
                    ...
                    <ul>
                        <li><i class="fa fa-chevron-right thin-chevron" class="f-para footer-text" style="color:#ffffff;"></i> <a href="/faq">FAQ</a></li>
                        <li><i class="fa fa-chevron-right thin-chevron" class="f-para footer-text" style="color:#ffffff;"></i> <a href="/announcement">Announcement</a></li>
                    </ul>
                </div>
