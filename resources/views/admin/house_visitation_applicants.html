...
<head>
  ...
  <title>For House Visitation Applicants</title>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="house_visitation_applicants.html" class="active">
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>For House Visitation</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <li class="breadcrumb-item">Applicants</li>
          <li class="breadcrumb-item active">For House Visitation </li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">For House Visitation  Applicants</h5>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <tr>
                    ...
                    <td> <span class="badge bg-primary">For House Visitation</span></td>
                    <td>
                        <div style="margin-bottom: 3px;">
                            <button type="button" class="btn" style="background-color: #356ddc; color: white; font-size: 12px; width: 100px; ">Approve</button>         
                          </div>
                          <div style="margin-bottom: 3px;">
