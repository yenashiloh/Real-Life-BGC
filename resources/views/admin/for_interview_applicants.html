...
<head>
  ...
  <title>For Interview Applicants</title>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="shortlisted_applicants.html">
              <i class="bi bi-circle"></i><span>Shortlisted</span>
            </a>
          </li>
          <li>
            <a href="for_interview_applicants.html" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">For Interview</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">For Interview  Applicants</h5>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <tr>
                    ...
                    <td> <span class="badge bg-primary">For Interview</span></td>
                    <td>
                        <div style="margin-bottom: 3px;">
                            <button type="button" class="btn" style="background-color: #356ddc; color: white; font-size: 12px; width: 140px; ">For House Visitation</button>         
                          </div>
                          <div style="margin-bottom: 3px;">
                            <button type="button" class="btn" style="background-color: #db2828; color: white; font-size: 12px; width: 140px;">Decline</button>
                          </div> 
                          <div style="margin-bottom: 3px;">
                            <button type="button" class="btn" style="background-color: #2EB85C; color: white; font-size: 12px; width: 140px;">View</button> 
                          </div>
                        </div>
                      </td>        
                  </tr>
