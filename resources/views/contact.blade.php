            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="contact-text">
                        <h2>Contact Info</h2>
                        <p>Simply submit your name, email address, the nature of your inquiry, and any background information below,
                ...
                <div class="col-lg-7 offset-lg-1">
                    <form action="{{ route('send.email') }}" class="contact-form" method="post">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <input type="text" name="first_name" class="form-control" style="color: #111111;" id="name" required  placeholder="First Name">
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="last_name" style="color: #111111;" id="name" required  placeholder="Last Name">
                            </div>
                            <div class="col-lg-12">
                                <input type="email" class="form-control" name="email" style="color: #111111;" id="email" required  placeholder="Email">
                            </div>
                            <div class="col-lg-12">
                                <input type="text" class="form-control" name="subject" style="color: #111111;" id="subject" required  placeholder="Subject">
                            </div>
                            <div class="col-lg-12">
                                <textarea class="form-control" name="content" rows="10" style="color: #111111;" required placeholder="Your Message"></textarea>
                                <button type="submit" class="text-center" id="submitBtn">
                                    <span id="submitText" style="color: white; font-size: 15px;" >Send</span>
                                    <span id="loadingSpinner" style="display: none; color: white; font-size: 15px;">Submitting...</span>
                                </button>
                            </div>
                        </div>
                    </form>
