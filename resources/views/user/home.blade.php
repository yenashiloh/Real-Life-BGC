                        ...
                        <section id="timeline" class="timeline-section  team">
                            ...
                            <ul class="timeline_ul">
                                <li class="timeline_li" style="--accent-color:#0A6E57;">
                                    ...
                                    <div class="title"></div>
                                    <div class="descr">Scholarship applications submitted through the form will be
                                        reviewed by February 2024.</div>
                                </li>
                                <li class="timeline_li" style="--accent-color:#0A6E57;">
                                    <div class="date">02</div>
                                    <div class="title"></div>
                                    <div class="descr">The team from the Real LIFE local center where you are filing
                                        your application will reach out to you sometime between February and March 2024
                                        to inform you if your application will proceed to the next screening stage.
                                    </div>
                                </li>
                                <li class="timeline_li" style="--accent-color:#0A6E57;">
                                    <div class="date">03</div>
                                    <div class="title"></div>
                                    <div class="descr">If found qualified, you will be invited for a panel interview by
                                        March or April 2024. You may be asked to bring in additional documents to
                                        complete your application.</div>
                                </li>
                                <li class="timeline_li" style="--accent-color:#0A6E57;">
                                    <div class="date">04</div>
                                    <div class="title"></div>
                                    <div class="descr">Applicants who pass the panel interview will be visited in their
                                        homes by March or April 2024.</div>
                                </li>
                                <li class="timeline_li" style="--accent-color:#0A6E57;">
                                    <div class="date">05</div>
                                    <div class="title"></div>
                                    <div class="descr">Recommended applications will be forwarded to the Real LIFE
                                        National Office for final review and approval by May 2024.</div>
                                </li>
                                <li class="timeline_li" style="--accent-color:#0A6E57;">
                                    <div class="date">06</div>
                                    <div class="title"></div>
                                    <div class="descr">Results of the scholarship applications will be released by the
                                        National Office by June-July 2024.</div>
                                </li>
                            </ul>
                            {{-- <br><br><br>
                            <div class="section-title">
