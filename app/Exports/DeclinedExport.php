...
class DeclinedExport implements FromCollection, WithHeadings, WithStyles
{
    /**
    ...
    public function collection()
{
    ...
    ->whereNotIn('applicants.status', ['New Applicant', 'Under Review', 'Shortlisted', 'For Interview', 'For House Visitation', 'Approved'])
    ->get()
    ->map(function ($item) {
