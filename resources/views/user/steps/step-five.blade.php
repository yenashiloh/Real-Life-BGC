...
<section id="progress-form__panel-5" role="tabpanel" aria-labelledby="progress-form__tab-5" tabindex="0" hidden>
    ...
    <div class="sm:d-grid sm:grid-col-2">
        ...
        <div class="form__field">
            <label for="currentSchool">
                ...
                <span data-required="true" aria-hidden="true"></span>
                <span style="margin-left: 15px; color: red; font-size: 10px; font-weight: normal;">Please
                    do not abbreviate</span>
            </label>
            <input value="" id="currentSchool" type="text" name="currentSchool" autocomplete="current school"
                required>
        </div>
    ...
    <h1 id="preferredProgramHeader" style="display: none; font-weight: bold;">Preferred Program</h1>
    <div class="sm:d-grid sm:grid-col-2">
